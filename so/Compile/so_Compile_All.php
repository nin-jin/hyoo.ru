...
class so_Compile_All {
    function __construct(){        
        ...
        foreach( $packs as $pack ):
            ...
            //    $name= &$names[ $prefix . '_' . $localName ];
            //    if( !$name ) $name= $minName++;
            //    return $prefix . $bs . $name;
            //};
            //foreach( $fileList as $file ):
            //    $minified= preg_replace_callback( '/\b(wc|lang)(_)([a-z0-9_-]+)/i', $replacer, $file->content );
            ...
            //    $registry[]= array( 'so_compile_name' => array( '@orig' => $orig, '@min' => 'm_' . $min ) );
            //endforeach;
